...
<html>
    ...
    <body>
        <%
         ...
         int result=stmt.executeUpdate("insert into zidio_task_management.employee(ename,email,mobile,role,age,dob,gender,username,password)values('"+ename+"','"+email+"',"+mobile+",'"+role+"',"+age+",'"+dob+"','"+gender+"','"+username+"','"+password+"')");
         if(result>0)
         {
